...
//Ali
void SingleCellData::printStressStrain(std::string FileName1,double curTime,double Init_Displace) {
...
void SingleCellData::printStressStrain_Ini(std::string FileName1) {
